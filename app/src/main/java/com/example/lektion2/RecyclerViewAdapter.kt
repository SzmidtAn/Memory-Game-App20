...
class RecyclerViewAdapter(mRecyclerList: RecyclerView?, list: MutableList<Element>) :
                ...
                if (checkElements.size > 1) {
                    ...
                    if (checkIfElementsSame(element1!!, element2!!)) {
                        ...
                        Handler().postDelayed({
                            ...
                            var elementsContext =
                                mRecyclerList!!.findViewHolderForAdapterPosition(element1!!.elementId)!!.itemView.imageImageView
                            var element2sContext =
                                mRecyclerList!!.findViewHolderForAdapterPosition(element2!!.elementId)!!.itemView.imageImageView
